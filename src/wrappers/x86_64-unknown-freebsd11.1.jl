# Autogenerated wrapper script for libdivsufsort_jll for x86_64-unknown-freebsd11.1
...
const libdivsufsort_splitpath = ["lib", "libdivsufsort.so"]
...
const libdivsufsort = "libdivsufsort.so.3"
